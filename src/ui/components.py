...
def run_app() -> None:
    ...
    st.markdown(
        ...
        <div style="display: flex; align-items: center; gap: 12px;">
            <h1 style="margin: 0;">Resume Screening Agent</h1>
            <a href="https://github.com/anuragparashar26/resume-screening-agent" target="_blank" style="text-decoration: none; display: flex; align-items: center;">
